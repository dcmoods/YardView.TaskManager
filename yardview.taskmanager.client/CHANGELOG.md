...
- Create Angular project with ng: `ng new yardview.taskmanager.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`yardview.taskmanager.client.esproj`).
